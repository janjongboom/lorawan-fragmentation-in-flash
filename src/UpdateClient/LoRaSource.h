...
#ifndef __UPDATE_CLIENT_LORA_SOURCE_H__
#define __UPDATE_CLIENT_LORA_SOURCE_H__
...
extern ARM_UPDATE_SOURCE ARM_UCS_LoRaSource;

#endif // __UPDATE_CLIENT_LORA_SOURCE_H__
